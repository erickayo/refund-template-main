...
9
// Observa os dados do input (oninput)
// Remover letras
...
function formatCurrencyBRL(value){
    //Formatar o valor no padrão BRL
...
form.onsubmit = (event) =>{
    ...
    // Cria um objetivo com os detalhes na nova despesa
    const newExpense ={
        id: new Date().getTime(),
...
function expenseAdd(newExpense){
    try{
        ...
        // Adicionar name e category na div das informações da despesa
